...
Given No matching record found in the employer digital account 
When an ILR file is submitted with the following data for the framework code 999999:
    | learner type       | agreed price | start date | planned end date | actual end date | completion status |
    | programme only DAS | 15000        | 01/09/2017 | 08/09/2018       | 08/08/2018      | completed         |
...
Given No matching record found in the employer digital account 
When an ILR file is submitted with the following data for the  programme type 999999:
    | learner type       | agreed price | start date | planned end date | actual end date | completion status |
    | programme only DAS | 15000        | 01/09/2017 | 08/09/2018       | 08/08/2018      | completed         |
...
Given No matching record found in the employer digital account 
When an ILR file is submitted with the following data for the  pathway code 999999:
    | learner type       | agreed price | start date | planned end date | actual end date | completion status |
    | programme only DAS | 15000        | 01/09/2017 | 08/09/2018       | 08/08/2018      | completed         |
...
Given No matching record found in the employer digital account 
When an ILR file is submitted with the following data for the  negotiated cost 999999:
    | learner type       | agreed price | start date | planned end date | actual end date | completion status |
    | programme only DAS | 15000        | 01/09/2017 | 08/09/2018       | 08/08/2018      | completed         |
