Feature: 1 learner aged 16-18, levy available, earns incentives
   ...
   Scenario: Payment for a 16-18 DAS learner, levy available, incentives earned
    ...
    Then the provider earnings and payments break down as follows:
		  | Type                           | 08/17 | 09/17 | 10/17 | 11/17 | ... | 08/18 | 09/18 | 
		  | Provider Earned                | 1000  | 1000  | 2000  | 1000  | ... | 2000  | 0     |  
		  | Provider Paid                  | 0     | 1000  | 1000  | 2000  | ... | 1000  | 2000  | 
		  | Levy account debited           | 0     | 1000  | 1000  | 1000  | ... | 1000  | 1000  | 
		  | SFA Levy budget                | 1000  | 1000  | 1000  | 1000  | ... | 1000  | 0     | 
		  | SFA co-funding budget          | 0     | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA additional payments budget | 0     | 0     | 1000  | 0     | ... | 1000  | 0     | 
#
#    And the transaction types for the payments are:
#      | Payment type       | 08/17 | 09/17 | 10/17 | ... | 08/18 | 
#      | On-program         | 1000  | 1000  | 1000  | ... | 1000  | 
#      | Completion         | 0     | 0     |       | ... | 0     | 
#      | Balancing          | 0     | 0     |       | ... | 0     |
#      | Employer incentive | 0     | 0     | 500   | ... | 500   |
#      | Provider incentive | 0     | 0     | 500   | ... | 500   |       
