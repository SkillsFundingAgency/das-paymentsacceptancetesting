...
Scenario: DPP-645 Payment for a non-DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time)

Given the apprenticeship funding band maximum is 15000
When an ILR file is submitted with the following data:
		  | ULN       | learner type                 | agreed price               | start date | planned end date | actual end date | completion status | aim type         |
		  | learner a | 19-24 programme only non-DAS | 15000                      | 06/08/2017 | 08/08/2018       |                 | continuing        | programme        |
		  | learner a | 19-24 programme only non-DAS | agreed within funding band | 06/08/2017 | 08/08/2018       | 08/08/2018      | completed         | maths or english |
...
Then the provider earnings and payments break down as follows:
		  ...
		  | SFA non-Levy provider additional payments budget | 0     | 0     | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy provider additional payments budget     | 0     | 0     | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | 0     | 0     | ... | 0     | 0     |
...
Scenario: DPP-645 Payment for a DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time)
			  
    Given levy balance > agreed price for all months
		
    And the following commitments exist:
		  | ULN       | start date            | planned end date   | agreed price | status   |
		  | learner a | 06/08/2017            | 08/08/2018         | 15000        | active   |
...
Scenario: DPP-646 Payment for a non - DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time)
...
#    The English or maths aim is submitted with the same start and planned end date
    ...
    Then the provider earnings and payments break down as follows:
		  ...
		  | SFA Levy employer budget                         | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0      |
		  | SFA non-Levy co-funding budget                   | 900     | 900     | 900     | 900     | 900     | ... | 900     | 0      |
		  | SFA non-levy provider additional payments budget | 29.44   | 29.44   | 29.44   | 29.44   | 29.44   | ... | 29.44   | 0      |
		  | SFA non-levy employer additional payments budget | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0      |
		  | SFA levy provider additional payments budget     | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0      |
		  | SFA levy employer additional payments budget     | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0      |
...
Scenario: DPP-646 Payment for a DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time)
...
#		  The English or maths aim is submitted with the same start and planned end date
    ...
    Then the provider earnings and payments break down as follows:
		  ...
		  | SFA non-levy provider additional payments budget | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0       |
		  | SFA non-levy employer additional payments budget | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0       |
		  | SFA levy provider additional payments budget     | 29.44   | 29.44   | 29.44   | 29.44   | 29.44   | ... | 29.44   | 0       |
		  | SFA levy employer additional payments budget     | 0       | 0       | 0       | 0       | 0       | ... | 0       | 0       |
...
Scenario: DPP-655 Payment for a non - DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time)
...
Scenario: DPP-655 Payment for a DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time)
...
When an ILR file is submitted with the following data:
		  | ULN       | learner type                  | agreed price | start date | planned end date | actual end date | completion status | funding adjustment for prior learning | other funding adjustment | aim type         |
		  | learner a | 19-24 programme only non-DAS  | 15000        | 06/08/2017 | 08/08/2018       |                 | continuing        | n/a                                   | n/a                      | programme        |
		  | learner a | 19-243 programme only non-DAS | 471          | 06/08/2017 | 08/08/2018       | 08/08/2018      | completed         | 0%                                    | n/a                      | maths or english |
...
Scenario: Payment for a non - DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time), other funding adjutsment is 75%, prior funding adjustment is 10%
...
#	Tech Guide 102. If an adjustment is required due to prior learning, you must record data in the ‘Funding adjustment for prior learning’ field on the ILR. 
	...
	When an ILR file is submitted with the following data:
		  | ULN       | learner type                 | agreed price | start date | planned end date | actual end date | completion status | funding adjustment for prior learning | other funding adjustment | restart indicator |
		  | learner a | 19-24 programme only non-DAS | 15000        | 06/08/2017 | 08/08/2018       | 08/01/2018      | break in learning | n/a                                   | n/a                      | n/a               |
		  | learner a | 19-24 programme only non-DAS | 471          | 06/08/2017 | 08/08/2018       | 08/01/2018      | break in learning | n/a                                   | n/a                      | n/a               |
		  | learner a | 19-24 programme only non-DAS | 15000        | 06/08/2018 | 08/03/2019       |                 | continuing        | n/a                                   | n/a                      | 1                 |
		  | learner a | 19-24 programme only non-DAS | 471          | 06/08/2018 | 08/03/2019       | 08/03/2019      | completed         | 42%                                   | n/a                      | 1                 |
		  
#	The English or maths aim is submitted with the same start and planned end date
      
    Then the provider P1 earnings and payments for the first episode of learning break down as follows:
		  ...
		  | SFA non-levy provider additional payments budget | 39.25 |39.25  | 39.25 | 39.25 | 39.25 | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | 0     | 0     | 0     |
		  | SFA levy provider additional payments budget     | 0     | 0     | 0     | 0     | 0     | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | 0     | 0     | 0     |

    And the transaction types for the provider P1 payments are:
    ...
    Then the provider P2 earnings and payments for the second episode of learning break down as follows:
		  | Type                                			 | 08/18 | 09/18 | 10/18 | ... | 02/19 | 03/19 |
		  | Provider Earned Total              				 |1039.25|1039.25|1039.25| ... |1039.25| 0     |
		  | Provider Paid by SFA                			 | 0     | 939.25| 939.25| ... | 939.25| 939.25|
		  ...
		  | SFA non-Levy provider additional payments budget | 39.25 | 39.25 | 39.25 | ... | 39.25 | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy provider additional payments budget     | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | ... | 0     | 0     |

    And the transaction types for the provider P2 payments are:
		  | Payment type                   | 09/18 | 10/18 | 11/18 | ... | 02/19 | 03/19 |
		  | On-program                     | 1000  | 1000  | 1000  | ... | 1000  | 1000  |
		  | Completion                     | 0     | 0     | 0     | ... | 0     | 0     |
		  | Balancing                      | 0     | 0     | 0     | ... | 0     | 0     |
          | English and maths on programme | 39.25 | 39.25 | 39.25 | ... | 39.25 | 39.25 |
...
Scenario: DPP-656 Payment for a DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time), other funding adjutsment is 75%, prior funding adjustment is 10%
...
#	Tech Guide 102. If an adjustment is required due to prior learning, you must record data in the ‘Funding adjustment for prior learning’ field on the ILR. 
	...
	When an ILR file is submitted with the following data:
		  ...
		  | learner a | 19-24 programme only non-DAS | 15000        | 06/08/2017 | 08/08/2018       | 08/01/2018      | break in learning | n/a                                   | n/a                      | n/a               | programme        |
		  | learner a | 19-24 programme only non-DAS | 471          | 06/08/2017 | 08/08/2018       | 08/01/2018      | break in learning | n/a                                   | n/a                      | n/a               | maths or english |
		  | learner a | 19-24 programme only non-DAS | 15000        | 06/08/2018 | 08/03/2019       |                 | continuing        | n/a                                   | n/a                      | 1                 | programme        |
		  | learner a | 19-24 programme only non-DAS | 471          | 06/08/2018 | 08/03/2019       | 08/03/2019      | completed         | 42%                                   | n/a                      | 1                 | maths or english |
		  
#	The English or maths aim is submitted with the same start and planned end date
      
    Then the provider earnings and payments for the first episode of learning break down as follows:
		  | Type                               				 | 08/17 | 09/17 | 10/17 | 11/17 | 12/17 | 01/18 |
		  | Provider Earned Total              				 |1039.25|1039.25|1039.25|1039.25|1039.25| 0     |
		  ...
		  | SFA non-levy provider additional payments budget | 0     | 0     | 0     | 0     | 0     | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | 0     | 0     | 0     |
		  | SFA levy provider additional payments budget     | 39.25 |39.25  | 39.25 | 39.25 | 39.25 | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | 0     | 0     | 0     |
    ...
    Then the provider earnings and payments for the second episode of learning break down as follows:
		  | Type                              				 | 08/18 | 09/18 | 10/18 | ... | 02/19 | 03/19 |
		  | Provider Earned Total              				 |1039.25|1039.25|1039.25| ... |1039.25| 0     |
		  ...
		  | SFA Levy co-funding budget          			 | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA Levy co-funding budget          			 | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA non-Levy provider additional payments budget | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy provider additional payments budget     | 39.25 | 39.25 | 39.25 | ... | 39.25 | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | ... | 0     | 0     |
...
Scenario: DPP-678 Payment for a non - DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time), other funding adjutsment is 75%, prior funding adjustment is 10%
...
#	Tech Guide 102. If an adjustment is required due to prior learning, you must record data in the ‘Funding adjustment for prior learning’ field on the ILR. 
	...
	| P1       | learner a | 19-24 programme only non-DAS | 15000        | 06/08/2017 | 08/08/2018       | 08/01/2018      | break in learning | n/a                                   | n/a                      | n/a               | programme        |
	| P1       | learner a | 19-24 programme only non-DAS | 471          | 06/08/2017 | 08/08/2018       | 08/01/2018      | break in learning | n/a                                   | n/a                      | n/a               | maths or english |
	| P2       | learner a | 19-24 programme only non-DAS | 15000        | 09/01/2018 | 08/08/2018       |                 | continuing        | n/a                                   | n/a                      | 1                 | programme        |
	| P2       | learner a | 19-24 programme only non-DAS | 471          | 09/01/2018 | 08/08/2018       | 08/08/2018      | completed         | 70%                                   | n/a                      | 1                 | maths or english |
...
#	The English or maths aim is submitted with the same start and planned end date
    ...
    Then the provider P2 earnings and payments for the second episode of learning break down as follows:
		  ...
		  | SFA Levy co-funding budget          			 | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA Levy co-funding budget          			 | 900   | 900   | 900   | ... | 900   | 0     |
		  | SFA non-Levy provider additional payments budget | 47.10 | 47.10 | 47.10 | ... | 47.10 | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy provider additional payments budget     | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | ... | 0     | 0     |
...
Scenario: DPP-678 Payment for a DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time), other funding adjutsment is 75%, prior funding adjustment is 10%
...
#	Tech Guide 102. If an adjustment is required due to prior learning, you must record data in the ‘Funding adjustment for prior learning’ field on the ILR. 
    ...
    And the following commitments exist:
	Provider	  | ULN       | price effective date  | planned end date   | agreed price | status   |
		P1        | learner a | 06/08/2017            | 08/08/2018         | 15000        | closed   |
		P2        | learner a | 09/01/2018            | 08/08/2018         | 15000        | active   |
...
#	The English or maths aim is submitted with the same start and planned end date
    ...
    Then the provider earnings and payments for the second episode of learning break down as follows:
		  ...
		  | SFA non-Levy provider additional payments budget | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA non-levy employer additional payments budget | 0     | 0     | 0     | ... | 0     | 0     |
		  | SFA levy provider additional payments budget     | 47.10 | 47.10 | 47.10 | ... | 47.10 | 0     |
		  | SFA levy employer additional payments budget     | 0     | 0     | 0     | ... | 0     | 0     |
...
Scenario: DPP-679 Payment for a non - DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time), other funding adjutsment is 75%
...
Scenario: DPP-679 Payment for a DAS learner, funding agreed within band maximum, planned duration is same as programme (assumes both start and finish at same time), other funding adjutsment is 75%
...
#	Providers are paid £471 per aim. this is funded from outside the total proce and is flat-profiled across the planned number of months in learning for that aim. There is no N+1, there is no money held back for completion. 
	...
	When an ILR file is submitted with the following data:
		  | ULN       | learner type                  | agreed price | start date | planned end date | actual end date | completion status | funding adjustment for prior learning | other funding adjustment | aim type         |
		  | learner a | 19-24 programme only non-DAS  | 15000        | 06/08/2017 | 08/08/2018       |                 | continuing        | n/a                                   | n/a                      | programme        |
		  | learner a | 19-243 programme only non-DAS | 471          | 06/08/2017 | 08/08/2018       | 08/08/2018      | completed         | n/a                                   | 75%                      | maths or english |
