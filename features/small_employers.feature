...
Scenario: Payment for a 16-18 non-DAS learner, small employer at start
    ...
    Then the provider earnings and payments break down as follows:
        ...
        | SFA non-Levy additional payments budget | 0     | 0     | 0     | 1000  | 0     | ... | 0     | 1000  | 0     |
...
Scenario: 1 learner aged 16-18, non-DAS. Second employment status record added with same employer id but small employer flag removed. Learner retains small employer funding.
    ...
    Then the provider earnings and payments break down as follows:
		...
		| Provider Earned from SFA                | 500   | 500   | 500   | 1500  | 500   | ... | 2500  | 0     |
		| Provider Earned from Employer           | 0     | 0     | 0     | 0     | 0     | ... | 0     | 0     |
		| Provider Paid by SFA                    | 0     | 500   | 500   | 500   | 1500  | ... | 500   | 2500  |
