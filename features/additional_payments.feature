...
Scenario:671-AC01 DAS learner, levy available, is taking an English or maths qualification, has learning support and the negotiated price changes during the programme
    ...
    Then the data lock status will be as follows:
	 ...
	 And the provider earnings and payments break down as follows: 
        ...
        | Provider Earned Total               | 933.64  | 933.64 | 933.64 | 583.64  | 583.64 | 583.64 |       
        | Provider Earned from SFA            | 933.64  | 933.64 | 933.64 | 583.64  | 583.64 | 583.64 |       
        | Provider Earned from Employer       | 0       | 0      | 0      | 0       | 0      | 0      |       
        | Provider Paid by SFA                | 0       | 933.64 | 933.64 | 933.64  | 583.64 | 583.64 |        
        | Payment due from Employer           | 0       | 0      | 0      | 0       | 0      | 0      |       
        | Levy account debited                | 0       | 750    | 750    | 750     | 400    | 400    |         
        | SFA Levy employer budget            | 750     | 750    | 750    | 400     | 400    | 400    |        
	...
	And the transaction types for the payments are:
		...
		| On-program                     | 750   | 750   | 750   | 400   | 400   |
...
Scenario:671-AC02 Non-DAS learner, levy available, is taking an English or maths qualification, has learning support and the negotiated price changes during the programme
    ...
    Then the provider earnings and payments break down as follows: 
        | Type                                    | 08/17   | 09/17  | 10/17   | 11/17   | 12/17  | 01/18  | 
        | Provider Earned Total                   | 858.64  | 858.64 | 858.64  | 543.64  | 543.64 | 543.64 |       
        | Provider Earned from SFA                | 858.64  | 858.64 | 858.64  | 543.64  | 543.64 | 543.64 |       
        | Provider Earned from Employer           | 75      | 75     | 75      | 40      | 40     | 40     |       
        | Provider Paid by SFA                    | 0       | 858.64 | 858.64  | 858.64  | 543.64 | 543.64 |        
        | Payment due from Employer               | 0       | 75     | 75      | 75      | 40     | 40     |       
        | Levy account debited                    | 0       | 0      | 0       | 0       | 0      | 0      |         
        | SFA Levy employer budget                | 0       | 0      | 0       | 0       | 0      | 0      |
        | SFA Levy co-funding budget              | 0       | 0      | 0       | 0       | 0      | 0      |
        | SFA non-Levy co-funding budget          | 675     | 675    | 675     | 360     | 360    | 360    |               
    ...
    And the transaction types for the payments are:
		| Payment type                   | 09/17 | 10/17 | 11/17 | 12/17 | 01/18 |
		| On-program                     | 675   | 675   | 675   | 360   | 360   |
		| Completion                     | 0     | 0     | 0     | 0     | 0     |
		| Balancing                      | 0     | 0     | 0     | 0     | 0     |
        | English and maths on programme | 33.64 | 33.64 | 33.64 | 33.64 | 33.64 |
		| English and maths Balancing    | 0     | 0     | 0     | 0     | 0     |
