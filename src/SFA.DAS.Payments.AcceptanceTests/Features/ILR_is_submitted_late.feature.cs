...
#line hidden
            ...
            table271.AddRow(new string[] {
                        ...
                        "continuing"});
#line 10
        testRunner.When("an ILR file is submitted for the first time on 28/12/17 with the following data:", ((string)(null)), table271, "When ");
#line hidden
            ...
            table272.AddRow(new string[] {
                        ...
                        "..."});
#line 13
        testRunner.Then("the provider earnings and payments break down as follows:", ((string)(null)), table272, "Then ");
#line hidden
