...
#line hidden
            ...
            table413.AddRow(new string[] {
                        ...
                        "15/11/2017"});
#line 177
        testRunner.When("the providers submit the following ILR files:", ((string)(null)), table413, "When ");
#line hidden
            ...
            table414.AddRow(new string[] {
                        ...
                        ""});
#line 182
        testRunner.Then("the data lock status will be as follows:", ((string)(null)), table414, "Then ");
#line hidden
            ...
            table415.AddRow(new string[] {
                        ...
                        "0"});
#line 188
       testRunner.And("the earnings and payments break down for provider a is as follows:", ((string)(null)), table415, "And ");
#line hidden
...
#line hidden
            ...
            table418.AddRow(new string[] {
                        ...
                        "0"});
#line 219
        testRunner.And("the transaction types for the payments for provider b are:", ((string)(null)), table418, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table425.AddRow(new string[] {
                        ...
                        "0"});
#line 283
         testRunner.And("the transaction types for the payments for provider b are:", ((string)(null)), table425, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table430.AddRow(new string[] {
                        ...
                        "500"});
#line 326
         testRunner.And("the transaction types for the payments for provider a are:", ((string)(null)), table430, "And ");
#line hidden
...
#line hidden
            ...
            table432.AddRow(new string[] {
                        ...
                        "0"});
#line 347
         testRunner.And("the transaction types for the payments for provider b are:", ((string)(null)), table432, "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
